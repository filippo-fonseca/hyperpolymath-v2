...
**Plans**: TBD — defined by /gsd:plan-phase 9 (rough estimate: 1–2 plans — Drizzle migration + server timing collection + /insights chart + regression test)
**UI hint**: yes
...
| 10. TTS + Route-Boundary Latency Wins | 0/TBD | Not started | - |
