...
export function HabitsInsightsPanel({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 rounded-xl border border-[var(--edge)] bg-[var(--surface)] px-4 py-3">
      ...
      <ul className="flex flex-col gap-3">
        {sortedRows.map(({ habit, scheduled, done, streak, rate, createdISO }) => {
          ...
          return (
            <li
              key={habit.id}
              className="rounded-xl border border-[var(--edge)] bg-[var(--surface)] px-4 py-3 flex flex-col gap-2.5"
            >
