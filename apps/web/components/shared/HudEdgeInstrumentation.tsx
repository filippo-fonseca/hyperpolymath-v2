...
export function HudEdgeInstrumentation({
  ...
  return (
    <div
      className={`hidden md:flex items-center gap-4 -stats text-micro text-[var(--ink-muted)] opacity-40 hover:opacity-85 transition-opacity duration-200 ease-out ${className}`}
      aria-hidden="true"
    >
