    ...
    try {
      ...
      const result = await invokeInDocumentJarvis({
        ...
        prompt: isFirstRun
          ...
          : "Process only the new or changed parts of this daily page (the TARGET content): extract tasks, events, and captures from them and create them. The rest of the page is context only — do not re-create anything already captured from it.",
        pageId: initialPage.id,
      });
