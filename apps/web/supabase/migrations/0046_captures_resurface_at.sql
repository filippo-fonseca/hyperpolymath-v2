-- 0046 — Resurfacing (remind-me) date on captures (mirror of drizzle/0029).
--
...
ALTER TABLE public.captures ADD COLUMN IF NOT EXISTS resurface_at timestamptz;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS captures_user_resurface_idx ON public.captures (user_id, resurface_at) WHERE resurface_at IS NOT NULL;
