...
ALTER TABLE "users"
ADD COLUMN IF NOT EXISTS "sms_jarvis_enabled" boolean NOT NULL DEFAULT false;
ALTER TABLE "users"
ADD COLUMN IF NOT EXISTS "sms_jarvis_last_reply_at" timestamptz;
ALTER TABLE "users"
ADD COLUMN IF NOT EXISTS "sms_jarvis_last_status" text;
ALTER TABLE "users"
ADD COLUMN IF NOT EXISTS "sms_jarvis_last_error" text;
...
CREATE INDEX IF NOT EXISTS "jarvis_sms_events_from_idx" ON "jarvis_sms_events" USING btree ("from_number", "created_at");
CREATE INDEX IF NOT EXISTS "jarvis_sms_events_created_idx" ON "jarvis_sms_events" USING btree ("created_at" DESC);
