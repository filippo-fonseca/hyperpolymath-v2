-- 0054 — mirror of drizzle/0036_entity_embeddings.sql.
--
-- Kept byte-identical to its drizzle counterpart below the header, per the rule
-- documented in 0049: a new drizzle migration is mirrored here in the same
-- commit, or the two directories drift again.
