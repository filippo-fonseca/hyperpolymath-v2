-- 0029 — Linked-people derivation marker on captures + tasks.
--
...
-- ('capture','task')).
ALTER TABLE "captures" ADD COLUMN IF NOT EXISTS "people_derived_at" timestamp with time zone;
--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN IF NOT EXISTS "people_derived_at" timestamp with time zone;
