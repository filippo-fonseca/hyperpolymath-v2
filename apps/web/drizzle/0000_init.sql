CREATE TYPE "public"."priority" AS ENUM('P∞', 'P1', 'P2', 'P3');--> statement-breakpoint
CREATE TYPE "public"."semester_term" AS ENUM('fall', 'spring', 'summer');--> statement-breakpoint
CREATE TYPE "public"."task_status" AS ENUM('not started', 'up next', 'in progress', 'almost done', 'lesno');--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "areas_user_active_idx" ON "areas" USING btree ("user_id") WHERE archived_at IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "captures_user_created_desc_idx" ON "captures" USING btree ("user_id",created_at DESC);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "captures_hashtags_hashtag_idx" ON "captures_hashtags" USING btree ("hashtag_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "captures_hashtags_user_idx" ON "captures_hashtags" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "captures_projects_project_idx" ON "captures_projects" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "captures_projects_user_idx" ON "captures_projects" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "hashtags_user_name_uniq" ON "hashtags" USING btree ("user_id","name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "kiwi_events_user_turn_idx" ON "kiwi_events" USING btree ("user_id",turn_at DESC);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "projects_user_area_active_idx" ON "projects" USING btree ("user_id","area_id") WHERE archived_at IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "projects_user_class_idx" ON "projects" USING btree ("user_id","is_class") WHERE is_class = true;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tasks_user_status_idx" ON "tasks" USING btree ("user_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tasks_user_due_idx" ON "tasks" USING btree ("user_id","due_date") WHERE due_date IS NOT NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tasks_projects_project_idx" ON "tasks_projects" USING btree ("project_id");--> statement-breakpoint
