...
// Ported verbatim from apps/web/lib/voice/encode-wav.ts.
// Float32Array (16 kHz mono from cpal IPC) -> WAV Blob for POST body.
// Single-channel, 16-bit PCM, configurable sample rate (default 16000).
